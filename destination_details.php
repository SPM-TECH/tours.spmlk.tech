...
<body>
    ...
    <div class="destination_banner_wrap overlay">
        <div class="destination_text text-center">
            <h3> Lagoon Sail</h3>
            <p>Dive into Kallady's Heart, Catch, Cook, and Connect</p>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-9">
                    <div class="destination_info">
                        <h3>Description</h3>
                        <p>Sail into Kallady River for a hands-on fish-catching thrill with seasoned local fishermen, all while ensuring safety. Then, step into the heart of the community, where you'll cook up your catch in a traditional kitchen alongside friendly locals. </p>
                        <p>It's not just about the tasty fish curry – it's a blend of adventure, shared moments, and the warmth of a genuine connection with the locals. Join us for a simple, yet unforgettable, eco-tour where fishing, cooking, and laughter come together by the river.</p>
            ...
            <div class="col-lg-8 col-md-9">
                <div class="destination_info">
                    ...
                    <ul>
                        ...
                        <li>Fishing Gears</li>
                        <li>Customizable fish recipe</li>
                        <li>Cooked Keeri Samba Rice and a veg curry</li>
                    </ul><br>
                    <h3>Price</h3>
                    <p><b>LKR 7000</b></p>
                </div>
...
<div class="destination_details">
    ...
    <button disabled> Safety life Jackets</button>
    <button disabled>Fishing Gears</button>
    <button disabled>Customizable fish recipe</button>
    <button disabled>Cooked Keeri Samba Rice and a veg curry</button>
</div>

<div class="bordered_1px"></div>
<div class="destination_details">
    <h3>Price details:</h3>
    <button disabled> LKR 8000</button>
</div>
                    </div>
                    <div class="bordered_1px"></div>
